...
<head>
    ...
    <!--/Favicon-->
    <meta name="msapplication-TileColor" content="#fe9bb1">
    <meta name="theme-color" content="#fe9bb1">
    <?php wp_head(); ?>
</head>
...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
        ...
        <!-- Header -->
        <header id="masthead" class="site-header px-4">
            <div class="container mx-auto">
                <section class="flex items-center py-4 pxsera-4">
                    <div class="sitelogo w-9/12 lg:w-1/5 ">
